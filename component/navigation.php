  ...
  <div class="navigation">
    <nav class="desktop">
      <div class="info-desktop">
        ...
        <!-- <a id="button-akun" onclick=showAkun()></a> -->
        <div id="info-desktop">
          <div></div>
          <div class="user">
        ...
        <ul>
          <li>
            <a href="../pages/daftar_obat.php?keyword=&halaman=1">
              <i class="fa-solid fa-book-medical"></i> Daftar Obat</a>
          </li>
          ...
          ?>
          <?php
          // jika role kurang dari atau sama dengan 2 menu tambahkan obat tidak ada
          if ($_SESSION['role'] <= 2) {
            echo '
              <li>
            <a href="../pages/tambah_stok_obat.php">
              <i class="fas fa-pills"></i> Tambah Stok</a>
              </li>';
          }
          ?>
    ...
    <nav class="mobile">
      <ul>
        ...
        <?php if ($_SESSION['role'] == 1) echo '
               <li>
            <a href="../pages/tambah_pengguna.php"><i class="fas fa-user-plus" title="add_account" title="tambah pengguna"></i></a>
            </li>            
            ';
        ?>
        <?php
        ...
        if ($_SESSION['role'] <= 2) {
          echo '
              <li>
            <a href="../pages/tambah_stok_obat.php">
              <i class="fas fa-pills" title="tambah stok obat"></i></a>
              </li>';
        }
        ?>
      </ul>
